...
public class EndPoints {
	...
	public static String getStore_url = base_uel+"store/order/{id}";
	public static String deleteStore_url = base_uel+"store/order/{id}";
	
	//Pet Model
	
	public static String postPet_url = base_uel+"pet";
	public static String postPetImage_url = base_uel+"pet/{id}/uploadImage";
	public static String getPetByStatus_url = base_uel+"pet/findByStatus";
	public static String getPetById_url = base_uel+"pet/{id}";
	public static String postPetById_url = base_uel+"pet/{id}";
	public static String deletePet_url = base_uel+"pet/{id}";
