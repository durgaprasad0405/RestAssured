...
public class PostBook extends Global {
	...
	public PostBook() throws FileNotFoundException, IOException, ParseException {
...
//						excelOps.setCellValue(excelFileName, sheetName, rn, cn, id);
//		
//						
